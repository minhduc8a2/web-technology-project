...
<body>
  ...
  <main>
      ...
      <div class="carousel-inner">
        <div class="carousel-item  active" data-bs-interval="2000">
          ...
          <div class="carousel-caption  d-none d-lg-block  text-start " style="padding-bottom: 10rem;">
            ...
            <a href="/search.php?search=giày"><button class="styled-btn fw-bold mt-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          ...
          <div class="carousel-caption  d-lg-none   ">
            ...
            <a href="/search.php?search=giày" class=""><button class="styled-btn fw-bold mt-4 mb-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          </div>
        ...
        <div class="carousel-item" data-bs-interval="4000">
          ...
          <div class="carousel-caption  d-none d-lg-block  text-start " style="padding-bottom: 10rem;">
            ...
            <a href="/search.php?search=samba"><button class="styled-btn fw-bold mt-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          </div>
          <div class="carousel-caption  d-lg-none   ">
            <h5 class="fs-1">TỎA SÁNG CÙNG SAMBA</h5>
            <p class="" style="max-width: 500px;">Châu Bùi, 24K.RIGHT, Lil Thu, Nick Q Tran tỏa sáng cùng Samba. Bạn thì sao?</p>
            <a href="/search.php?search=samba" class=""><button class="styled-btn fw-bold mt-4 mb-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          </div>
        </div>
        <div class="carousel-item" data-bs-interval="4000">
          ...
          <div class="carousel-caption  d-none d-lg-block  text-start " style="padding-bottom: 10rem;">
            ...
            <a href="/search.php?search=ian+wright"><button class="styled-btn fw-bold mt-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          </div>
          <div class="carousel-caption  d-lg-none   ">
            <h5 class="fs-1">ARSENAL X IAN WRIGHT</h5>
            <p class="" style="max-width: 500px;">Tôn vinh ký ức, khoảnh khắc và con người của Huyền thoại Arsenal trong suốt sự nghiệp của anh.</p>
            <a href="/search.php?search=ian+wright" class=""><button class="styled-btn fw-bold mt-4 mb-4">MUA NGAY <i class="fa-solid fa-arrow-right "></i></button></a>
          </div>
        </div>
      </div>
    ...
    <div class="standout-product mt-new-section">
